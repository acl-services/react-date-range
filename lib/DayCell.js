...
var DayCell = (function (_Component) {
  ...
  _createClass(DayCell, [{
    ...
    value: function handleSelect(event) {
      ...
      var dayMoment = _props2.dayMoment;
    ...
    value: function getStateStyles() {
      ...
      var isSelected = _props3.isSelected;
      var isInRange = _props3.isInRange;
      var isPassive = _props3.isPassive;
      var isStartEdge = _props3.isStartEdge;
      var isEndEdge = _props3.isEndEdge;
      var dayMoment = _props3.dayMoment;
      var isToday = _props3.isToday;
      var isSunday = _props3.isSunday;
    ...
    value: function getClassNames(classes) {
      ...
      var isSelected = _props4.isSelected;
      var isInRange = _props4.isInRange;
      var isPassive = _props4.isPassive;
      var isStartEdge = _props4.isStartEdge;
      var isEndEdge = _props4.isEndEdge;
      var isToday = _props4.isToday;
      var isSunday = _props4.isSunday;
      var isDisabled = _props4.isDisabled;

      return (0, _classnames3['default'])((_classnames = {}, _defineProperty(_classnames, classes.day, true), _defineProperty(_classnames, classes.dayActive, isSelected), _defineProperty(_classnames, classes.dayPassive, isPassive), _defineProperty(_classnames, classes.dayInRange, isInRange), _defineProperty(_classnames, classes.dayStartEdge, isStartEdge), _defineProperty(_classnames, classes.dayEndEdge, isEndEdge), _defineProperty(_classnames, classes.dayToday, isToday), _defineProperty(_classnames, classes.daySunday, isSunday), _defineProperty(_classnames, classes.dayDisabled, isDisabled), _classnames));
    }
  }, {
    key: 'render',
    value: function render() {
      var _props5 = this.props;
      var dayMoment = _props5.dayMoment;
