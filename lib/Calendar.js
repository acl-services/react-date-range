  ...
  _createClass(Calendar, [{
    ...
    value: function renderDays(classes) {
      ...
      for (var i = 1; i <= dayCount; i++) {
        ...
        var dayMomentFormatted = dayMoment.format('YYYY-MM-DD');
      ...
      return days.map(function (data, index) {
        ...
        var isDisabled = maxRange && dayMoment.startOf('day').isAfter(range.startDate.clone().add(maxRange));
...
Calendar.propTypes = {
  ...
  disableDaysBeforeDate: _propTypes2['default'].string,
